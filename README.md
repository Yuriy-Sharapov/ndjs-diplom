...
:white_check_mark: РЕШЕНИЕ Сервис объявлений на Docker Hub: https://hub.docker.com/r/14101916/advert

```Batchfile
docker pull 14101916/advert:v1.0.0
```

:white_check_mark: В отдельный сервис выделен счетчик обращейни к объявлению: https://hub.docker.com/r/14101916/redis_counter
